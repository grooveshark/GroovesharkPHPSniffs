 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Grooveshark_Sniffs_Arrays_ArrayDeclarationSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        } else if ($tokens[$arrayEnd]['column'] !== $keywordStart + 6) {
            // Check the closing bracket is lined up under the a in array.
            $expected = $keywordStart + 6;
        ...
        */
        ...
        foreach ($indices as $index) {
            ...
            if ($tokens[$index['index']]['column'] !== $indicesStart + 5) {
